...
// ✅ Custom SVG for the official Telegram Icon
...
const socialLinks: SocialLink[] = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/share/g/18oktDj9Yc/?mibextid=wwXIfr",
    icon: Facebook,
  },
  ...
  {
    name: "Telegram",
    href: "https://t.me/+3QA12Ufg5HphMGE0",
    icon: TelegramIcon,
  },
      ...
      <div className="container mx-auto px-4 py-16 lg:px-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-6">
            <Link
              href="/privacy"
              className="hover:text-medical-600 dark:hover:text-medical-400 transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
